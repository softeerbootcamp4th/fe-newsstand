...
export const allNewsData = [
    {
        ...
        company: [
            ...
            },
            {
                ...
                news: [
                    { id: 1, title: 'Supreme Court kicks cases about tech companies’ First Amendment rights back to lower courts' },
                    { id: 2, title: 'Record labels are suing tech companies for copying classic songs' },
                    { id: 3, title: 'Bitcoin Shows High Volatility Amid Unexpected U.S. Manufacturing PMI Data' },
                    { id: 4, title: 'Homestays can help refugee women get to grips with life in a new country' },
                    { id: 5, title: 'Standing out to fit in: How new employees can set themselves up for success at a new workplace' },
                    { id: 6, title: 'Fast fashion is harming our planet — these 4 tips can help you build a more sustainable wardrobe' },
                ],
            },
        ],
    },
        ...
        company: [
            {
                ...
                news: [
                    ...
                    { id: 6, title: '10대 뇌전증 환자 뇌에 처음으로 신경자극기 이식..."발작 80%까지 감소"해...' },
                ],
            },
            {
                companyId: 2,
    ...
    },
    {
        ...
        company: [
            ...
            },
            {
                ...
                mainNews: {
                    id: 1,
                    src: 'https://picsum.photos/500/300?img=5',
                    title: "20초 만에 고꾸라져...'중국판 스페이스-X'의 굴욕?",
                },
                news: [
                    { id: 1, title: '폭우·태풍에 좌우될 한 해 농사...피해 줄이려면?' },
        ...
        company: [
            {
                ...
                news: [
                    {
                        id: 1,
                        title: "[2025 6월모평] '역대급 난도 불구 전영역 만점자 6명’.. 표점 최고점 국어148 수학152, 영어 1등급 1.47% ‘역대 최저’",
                    },
                    {
                        id: 2,
                    ...
                    {
                        id: 3,
                        title: '[단독] 2024 US뉴스 세계대학순위.. 서울대 ‘10년 연속 국내 톱’ 연대 세종대 성대 KAIST 톱5',
                    },
                    {
                        id: 4,
                        title: "[2025수시] '논술 경쟁률 겁먹지 마라'..‘주목! 실질경쟁률’ 중대 의학 203→45대1, 인하대 의예 661→71대1 ‘급감’",
                    },
                    {
                        id: 5,
                        title: "2025대입 '3개월앞두고 역대급' 전형변화 ‘수요자 패닉’.. ‘아예 사라진 사전예고 취지’",
                    },
                    {
                        id: 6,
                        title: '[단독] 2025수시 지원 ‘유의’..2024상반기 대교협 평가 ‘미인증’ 수원가톨릭대 화성의과학대 등 21개교',
                    },
                ],
            },
            {
...
export const getNewsData = (category, id) => {
    ...
    let companyData = newsDatas[0].company.find((company) => company.companyId === id)
